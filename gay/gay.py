...
words = open('/Users/CodyFulcher/Desktop/Haiku/gay/words.txt', 'w')
tweets = open('/Users/CodyFulcher/Desktop/Haiku/gay/tweets.txt', 'w')
...
def priorityWords():
	wordcount = re.findall('\w+', open('/Users/CodyFulcher/Desktop/Haiku/gay/tweets.txt').read().lower())

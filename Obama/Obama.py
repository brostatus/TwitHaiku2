...
words = open('/Users/CodyFulcher/Desktop/Haiku/obama/words.txt', 'w')
tweets = open('/Users/CodyFulcher/Desktop/Haiku/obama/tweets.txt', 'w')
...
def priorityWords():
	wordcount = re.findall('\w+', open('/Users/CodyFulcher/Desktop/Haiku/obama/tweets.txt').read().lower())
